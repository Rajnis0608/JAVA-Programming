...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        temp = new StockItem("towel",2.40,20);
        stockList.addStock(temp);
        ...
        //To check order of items when unmodified Map is returned from function
        for(String s : stockList.Items().keySet()) {
            System.out.println(s);
        }

        Basket myBasket = new Basket("Rajni");
        ...
        //removing all items from myBasket
